        ...
        >
          <defs>
            <linearGradient
              ...
              x2='2880.89'
              y2='4684.49'
              gradientTransform='matrix(1, 0, 0, -1, 0, 6020.95)'
          ...
          <path
            d='M1400,570H1.13V416.16C1.13,378.93,0,302.68,0,302.68S98.19,106,257.36,106c61.3,0,117,38,163.13,78.44S504.08,274,542.18,322c16.2,20.48,35.35,42.4,61.33,45,9,.9,18.09-.7,27-2.29,26.61-4.74,54.2-12.68,81-15,91.36-7.8,183.26,55.36,270.67,27.69,26.89-8.51,50.55-25.09,77-34.75,38.82-14.15,82.82-12.51,121.17,2.88,33,13.23,105.79,38.7,138.69,52.06,11,4.47,42.66-.71,50.2-32.37,11.15-46.88,30.73-56.93,30.73-56.93V570Z'
            style={{
              opacity: 0.3,
              isolation: "isolate",
          ...
          />
          <path
            d='M0,371.52S64.07,295.57,155.93,266s206.86-40.41,323.85,96.73C565.91,463.73,668,475.9,752.25,411.1c130.17-100.17,250.67-35.54,294.27-2s105.35,40.06,201.74-14.81c73.26-41.71,85.52-55,151.74-39V570H.24Z'
            style={{ fill: "url(#linear-gradient-2)" }}
          />
          <path
            d='M1400,362.82c-61.32-20.36-111.17,15.54-199.28,67.11-87.5,51.21-168.06-7-211.7-31.7S856.63,361.7,741.37,445.29,523.31,440.67,496.8,418,396.2,292.22,258.54,295.57,0,439.69,0,439.69V570H1399.81Z'
            style={{
              opacity: 0.3,
              isolation: "isolate",
          ...
          <path
            ...
            style={{ fill: "#d1e29b", opacity: 0.29, isolation: "isolate" }}
          />
          <path
            ...
            style={{ fill: "#d1e29b", isolation: "isolate" }}
          />
        </svg>
      </div>
    </header>
